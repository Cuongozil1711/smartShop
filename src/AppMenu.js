...
export const AppMenu = (props) => {
    ...
    return (
        <div className="layout-menu-container">
            <AppSubmenu items={props.model} onToggleMenuClick={props.onToggleMenuClick} className="layout-menu"  onMenuItemClick={props.onMenuItemClick} root={true} role="menu" />
