    ...
    return (
        ...
        >
            {show && (
                <div>
                    <div className="field">
                        <label htmlFor="name">Mã quầy hàng</label>
                    ...
                    <div className="field">
                        <label htmlFor="name">Tên quầy hàng <span className="text-red-600">*</span></label>
                    ...
                    <div className="field">
                        <label htmlFor="name">Địa chỉ <span className="text-red-600">*</span></label>
                        ...
                        {submitted && !itemData.address && <small className="text-red-600 p-invalid">Dữ liệu không được để trống</small>}
                    </div>
                </div>
            )}
        </Dialog>
